...
class OfferControllerTest extends TestCase
{
    ...
    public function test_user_can_list_offers(): void
    {
    ...
    public function test_creating_offer_requires_salary_and_content(): void
    {
        $response = $this->actingAs($this->user)->post(route('offers.store'), [
            'application_id' => $this->application->id,
            'salary' => '',
        ...
        $response->assertSessionHasErrors(['salary', 'content']);
    }
    ...
    public function test_unauthenticated_user_cannot_list_offers(): void
    {
